 ...
 *
 * License: www.highcharts_4.0.1.com/license
 */
		...
		init: function (pathAnim) {
			...
			$.fn.highcharts = function () {
				...
				if (this[0]) {
					...
					if (options === UNDEFINED) {
						ret = charts[attr(this[0], 'data-highcharts_4.0.1-chart')];
					}
				}
...
SVGRenderer.prototype = {
	...
	/**
	 * Create a group
	 * @param {String} name The group will be given a class name of 'highcharts_4.0.1-{name}'.
	...
	fontMetrics: function (fontSize) {
		...
		// Applies to the default font family. http://jsfiddle.net/highcharts_4.0.1/7xvn7/
...
Highcharts.VMLElement = VMLElement = {
	...
	setSpanRotation: function () {
		...
		// Test case: http://jsfiddle.net/highcharts_4.0.1/Ybt44/
...
Pointer.prototype = {
	...
	onDocumentMouseMove: function (e) {
		...
		if (chartPosition && hoverSeries && !this.inClass(e.target, 'highcharts_4.0.1-tracker') &&
	...
	onContainerMouseMove: function (e) {
		...
		if ((this.inClass(e.target, 'highcharts_4.0.1-tracker') ||
...
Chart.prototype = {
	...
	getContainer: function () {
		var chart = this,
			...
			chartHeight,
			renderTo,
			indexAttrName = 'data-highcharts_4.0.1-chart',
			oldChartIndex,
			containerId;
		...
		// because web pages that are saved to disk from the browser, will preserve the data-highcharts_4.0.1-chart
	...
	destroy: function () {
		...
		chartCount--;
		chart.renderTo.removeAttribute('data-highcharts_4.0.1-chart');
